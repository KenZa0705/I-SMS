        ...
        <div class="container-fluid pt-5">
            <div class="row g-4">
                ...
                <div class="col-md-8 pt-5 px-5">
                    ...
                    try {
                        $query = "SELECT s.*, yl.year_level, d.department_name, c.course_name FROM student s
                        ...
                        if (count($students) > 0) {
                            ...
                            echo '<thead class="table table-primary">
                                    <tr>
                                ...
                                echo "<tr>
                                        ...
                                        <div class='dropdown ms-auto'>
                                                ...
                                                <ul class='dropdown-menu' aria-labelledby='dropdownMenuButton $student_id'>
                                                    <li><a class='dropdown-item' href='edit_announcement.php?id $student_id'>Edit</a></li>
                                                    <li>
